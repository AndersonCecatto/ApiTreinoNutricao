...
namespace ApiTreinoNutricao.Data.Mapping
{
    public class TreinoMap : IEntityTypeConfiguration<Treino>
    {
        public void Configure(EntityTypeBuilder<Treino> builder)
        {
            ...
            builder.Property(p => p.Exercicios).HasColumnName("exercicios").HasColumnType("varchar(1000)");
            builder.Property(p => p.GrupoMuscular).HasColumnName("grupo_muscular").HasColumnType("varchar(1000)");
